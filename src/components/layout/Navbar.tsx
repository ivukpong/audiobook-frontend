...
import { Headphones, Library, LogOut, Settings } from "lucide-react";
          ...
          {user ? (
            <>
              ...
              <button
                ...
                className="flex items-center gap-1.5 px-3 py-1.5 text-sm text-gray-600 hover:text-red-600 rounded-lg hover:bg-red-50 transition-colors ml-1"
              >
